...
class IndexAction extends BaseAction{
    ...
    protected function _getMenu($fixkey=true) {
        ...
        $menu['service_服务管理']       =   array(
            '服务管理'      =>  array(
                '服务列表'  => 'Service/lists',
                '服务添加'  => 'Service/add',
				'客户信息'  => 'Service/kehulists',
                'H5信息'  => 'Service/yuesaoyy',
            ),
            /*'类别管理'      =>  array(
                '类别列表'  => 'Servicetype/lists',
                '类别添加'  => 'Servicetype/add',
            ),*/
        );

        $menu['mainprj_套餐管理']       =   array(
            '套餐管理'      =>  array(
                '套餐列表'  => 'Mainprj/lists',
                //'套餐添加'  => 'Mainprj/add',
                '套餐订单'  => 'Mainprjorder/lists',
        ...
        $menu['appointment_预约阿姨管理'] 		=   array(
    		'预约管理'		=>  array(
 				'预约阿姨列表'	=> 'Appointment/lists',       
    		),
               '月嫂服务管理'           =>  array(
                                '月嫂服务列表'  => 'Appointment/order',
                                '未处理列表'  => 'Appointment/orderw',
                                '已处理列表'  => 'Appointment/orderc',
                                '已拒绝列表'  => 'Appointment/orderj',
                                '已删除列表'  => 'Appointment/orderd',
               ),
               '育婴早教管理'          =>  array(
                                '育婴早教列表'	=> 'Appointment/infant_care',
                                '未处理列表'  => 'Appointment/infant_carew',
                                '已处理列表'  => 'Appointment/infant_carec',
                                '已拒绝列表'  => 'Appointment/infant_carej',
                                '已删除列表'  => 'Appointment/infant_cared',
               ),
	);
        ...
        $menu['member_会员管理'] 		=   array(
    		'会员管理'		=>  array(
 				'会员列表'	=> 'Member/lists',
                '宝宝护理项目'  => 'Hulibabyprjs/lists',
                '产妇护理项目'  => 'Hulimumprjs/lists',
    		),
		);
        ...
        $menu['material_食材管理'] 		=   array(
			    ...
			    /*'单位管理'		    =>  array(
        				'单位列表'	=> 'Package/lists_dw',
        				'单位添加'	=> 'Package/add_dw',
        		),*/
        		
        );
        $menu['zixun_咨询管理']      =   array(
                '营养管理'          =>  array(
                        '孕期咨询'  => 'Yunfoodschat/lists',
                        '月子咨询'  => 'Yuezifoodschat/lists',
                ),
        );
        $rt=array();
