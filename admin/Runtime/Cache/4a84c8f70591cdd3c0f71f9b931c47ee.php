...
<div class="right">
      <div class="w810 l">
		<div class="add_tit cl">
			<span class="l">位置：<a href="__APP__/Index/right">管理平台</a><b>食物列表</b></span>
		</div>
		<div class="web_tit">
		    <script type="text/javascript">
			var searchURL='__ACTION__';
			var searchIDs="f_name".split('|');
			</script>
            <input type="hidden" id="export" value="" >
			营养素名称：<input type="text" id="f_name" value="<?php echo ($para["f_name"]); ?>" size="8" >
