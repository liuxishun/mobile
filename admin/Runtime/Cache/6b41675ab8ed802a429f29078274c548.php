...
<div class="right">
      <div class="w810 l">
		<div class="add_tit cl">
			<span class="l">位置：<a href="__APP__/Index/right">管理平台</a><b>客户列表</b></span>
		</div>
		<div class="web_tit">
		    <script type="text/javascript">
			var searchURL='__ACTION__';
			var searchIDs="title|typeid".split('|');
			</script>
			标题：<input type="text" id="title" value="<?php echo ($para["title"]); ?>" size="8" >
        ...
        <table  class="list_table">
          ...
          <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr>
					...
					<td class="td_left"><?php if($val['thumb'])echo'<font style="color:red;" title="缩略图">[图]</font>'; ; echo ($val["name"]); ?></td>
					<td><?php echo ($val["phone"]); ?></td>
					<td>
						<?php echo ($val["yuchaqi"]); ?>
					</td>
                    <td>
						<?php echo ($val["city"]); ?>
					</td>
					...
					<td>
						<a href="__URL__/yuesaoyy_del/id/<?php echo ($val["id"]); ?>" class="link-del">删除</a>
					</td>
                    <!--<td><?php echo ($val["follow_num"]); ; echo ($val["address"]); ; echo ($val["review_num"]); ?></td>
					<td>
					...
					<td>
						<!--<a href="__URL__/listurl/id/<?php echo ($val["id"]); ?>/">编辑</a> |-->
