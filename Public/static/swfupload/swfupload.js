...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object '+(!document.addEventListener? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"' : '')+' id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
		        ...
		        //'<embed id="'+this.movieName+'" name="'+this.movieName+'" src="'+this.settings.flash_url+'" allowScriptAccess="always" wmode="'+this.settings.button_window_mode+'" FlashVars="'+this.getFlashVars()+'" menu="false" quality="high" width="'+ this.settings.button_width +'" height="'+ this.settings.button_height +'" type="application/x-shockwave-flash" pluginspage="http:www.macromedia.com/go/getflashplayer" />',
				'</object>'].join("");
};
