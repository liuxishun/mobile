    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function rollGear(target) {
                ...
                target["int_" + target.id] = setInterval(function() {
                    ...
                    var minTop = -(target.dataset.len - 1) * 2.4;
                    if (pos < minTop) {
                        pos = minTop;
                        setDuration();
                    }
                    if (stopGear) {
                        var gearVal = Math.abs(pos) / 2.4;
        ...
        setGearTooth: function(data) {
            ...
            if (l > 0) {
                ...
                gearChild[_self.index].style["-webkit-transform"] = 'translate3d(0,' + (-gearVal * 2.4) + 'em,0)';
                gearChild[_self.index].setAttribute('top', -gearVal * 2.4 + 'em');
