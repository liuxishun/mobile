...
<head>
    ...
    <style type="text/css">
    	.defen{ font-size: 26px; color: #d35286; }
    	.assignment2_d4{ width:480px; background:#f8f8f8; border-radius:11px; overflow:hidden; margin:40% auto 0;}
    	.assignment2_p22{ font-size:26px; text-align:center; color:#b2b2b2; line-height:40px; padding:30px 0; }
		...
		.assignment2_p41{ overflow:hidden; text-align:center;display: none;}
		.assignment2_p41 a{ display:inline-block; width:100%; font-size:24px; line-height:80px; border:1px solid #b2b2b2; text-align:center; color:#34316e;}
    </style>
	...
	<?php if(is_array($list)): foreach($list as $k=>$li): ?><div class="answer" id="k<?php echo ($k); ?>" style="display: none;">
        ...
        <div class="dati">
            ...
            <div class="dati_d1" data-answer="<?php echo ($li["answer"]); ?>">
                <?php if(is_array($li[daan])): foreach($li[daan] as $key=>$da): ?><P class="dati_p2"><label><input type="<?php echo $li['type']==1 ? 'radio' : 'checkbox';?>" name="v<?php echo ($k); ?>" value="<?php echo ($da["val"]); ?>" data-lab="<?php echo ($da["lab"]); ?>"><i><?php echo ($da["lab"]); ?></i><span><?php echo ($da["con"]); ?></span></label></P><?php endforeach; endif; ?>
            </div>
        </div>
...
<div class="assignment1_out">
	<div class="assignment2_d4">
        ...
        <P class="assignment2_p22">您已回答了<span class="yida">0</span>道题（共<span><?php echo ($count); ?></span>题）<br>考试得 <span class="defen">0</span> 分</P>
        <P class="assignment2_p4"><a class="assignment2_p4_a1" href="__URL__/quzheng?openid=<?php echo ($openid); ?>">继续学习</a><a class="assignment2_p4_a2" href="__SELF__">再测一次</a></P>
        <P class="assignment2_p41"><a href="https://www.sobot.com/chat/h5/index.html?sysNum=8b78fa06c8d349ce8556b8d7d4cc01cc">申请证书</a></P>
    </div>
</div>
...
<div class="assignment2_out">
	<div class="assignment2_d4">
    	<P class="assignment1_p1">温馨提示</P>
        <P class="assignment2_p22">您已回答了<span class="yida">0</span>道题（共<span><?php echo ($count); ?></span>题），<br>考试得分<span class="defen">0</span>，确定交卷吗？</P>
        <P class="assignment2_p4"><a class="assignment2_p4_a1" href="javascript:$('.assignment2_out').hide();">继续答题</a><a class="assignment2_p4_a2" onclick="addsub();">交卷</a></P>
    </div>
</div>
	...
	$('.dati_p2 input').click(function(e) {
		...
		if($(this).attr("type") == 'radio'){
			...
			$(this).parents(".dati_d1").find("label").each(function(){
				$(this).find("i").removeClass('dati_p2_i1').html($(this).find("input").data('lab'));
			});
