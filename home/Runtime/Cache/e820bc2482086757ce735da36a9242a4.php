...
<body style="background-color: #f3f3f3;">
    <section class="section section1">
        ...
        <form action="__URL__/dingdan" method="post">
        	<input type="hidden" name="USERID" value="<?php echo ($openid); ?>">
        	<input type="hidden" name="KCID" value="<?php echo ($pd["id"]); ?>">
        	<input type="hidden" name="MONEY" value="<?php echo ($pd["jine"]); ?>">
        	<input type="hidden" name="PAYCHANNEL" value="wx">
        	<input type="hidden" name="PAYCONTENT" value="<?php echo ($pd["title"]); ?>">
        	<input type="hidden" name="QUANID" value="<?php echo ($pd["quanid"]); ?>">
        	<input type="hidden" name="QUANE" value="<?php echo ($pd["quane"]); ?>">
        	<input type="hidden" name="STATE" value="0">
        	<input type="hidden" name="PINGID" value="0">
