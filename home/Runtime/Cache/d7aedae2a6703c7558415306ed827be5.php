...
<head>
    ...
    <style type="text/css">
     ...
     .yemian_p1 select{ width:410px; border:none; outline:none; height:60px; line-height:60px; padding-left:20px; background:#e2e2e2; font-size:26px; color:#565656;font-family:"微软雅黑";}
...
<body style="background-color: #fff;">
    <section class="section section1">
        ...
        <form class="yemian_form" action="__URL__/bangshouji" method="post" onsubmit="return add()">
         ...
         <p class="yemian_p1">
            <span class="yemian_s1">城市</span>
            <select name="city_id">
                <!--<option value="0">请选择城市</option>-->
                <?php if(is_array($cityList)): foreach($cityList as $key=>$item): ; if(($item["id"] == $cityId)): ?><option value="<?php echo ($item["id"]); ?>" selected><?php echo ($item["name"]); ?></option>
                    <?php else: ?>
