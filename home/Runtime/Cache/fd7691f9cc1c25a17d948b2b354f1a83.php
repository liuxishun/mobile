...
<!-- 
    ...
    <footer class="vedio_foot">
    	...
    	<!-- 
        <div class="vedio_tel">
        	<a href="tel:<?php echo ($arr["SCPHONE"]); ?>" class="vedio_tel_p1"><span class="vedio_tel_s1">电话咨询</span><span class="vedio_tel_s2">telephone</span></a>
            <a href="__URL__/didian?LNG=<?php echo ($arr["LNG"]); ?>&LAT=<?php echo ($arr["LAT"]); ?>" class="vedio_tel_p3"><span class="vedio_tel_s1">到这里去</span><span class="vedio_tel_s2">Go here</span></a>
        </div>
         -->
    </footer>
